...
<head>
    ...
    <title>Book Room - <?php echo $room['name']; ?></title>
...
<body>
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="">
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <a href="../room-details.php?id=<?php echo $roomId; ?>" class="btn btn-outline-secondary">Back to Room Details</a>
                            </div>
                        </form>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted"><?php echo $room['type_name']; ?></p>
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span class="fw-bold">$<?php echo number_format($room['price'], 2); ?></span>
                        </div>
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span>$<?php echo number_format($room['extra_person_fee'], 2); ?> per night</span>
                        </div>
    ...
    document.getElementById('check_in_date').addEventListener('change', function() {
        ...
        if (document.getElementById('check_out_date').value < minCheckOutDate) {
            document.getElementById('check_out_date').value = minCheckOutDate;
        }
    });
    </script>
</body>
