...
<head>
    ...
    <title>Booking Confirmation - <?php echo htmlspecialchars(SITE_NAME); ?></title>
                ...
                <div class="card confirmation-card">
                    ...
                    <div class="card-body">
                        <div class="text-center mb-4">
                            ...
                            <p>Booking ID: <strong><?php echo htmlspecialchars($booking['id']); ?></strong></p>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <p>
                                    <strong>Total Amount:</strong> NGN<?php echo number_format($booking['total_price'], 2); ?><br>
                                ...
                                <?php if ($booking['payment_method'] === 'bank_transfer' && $booking['payment_status'] === 'pending'): ?>
                                    <div class="alert alert-info">
                                        ...
                                        <p class="mb-0">
                                            ...
                                            Reference: ROOM-<?php echo htmlspecialchars($booking['id']); ?>
                                        </p>
                                    </div>
                                <?php endif; ?>
                            </div>
