...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
        ...
        if (empty($errors)) {
            ...
            if (move_uploaded_file($_FILES['image']['tmp_name'], $target_file)) {
                $imagePath = $filename; // Store as absolute path from web root
            } else {
    ...
    // If category is selected, get subcategories
    if (!empty($_POST['category_id'])) {
                    ...
                    <div class="card-body">
                        <form method="post" action="add-product.php" enctype="multipart/form-data">
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" id="price" name="price" step="0.01" min="0.01" value="<?php echo $_POST['price'] ?? ''; ?>" required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="subcategory_id" name="subcategory_id">
                                        ...
                                        <?php foreach ($subcategories as $subcategory): ?>
                                            <option value="<?php echo $subcategory['id']; ?>" <?php if (isset($_POST['subcategory_id']) && $_POST['subcategory_id'] == $subcategory['id']) echo 'selected'; ?>>
                            ...
                            <div class="mb-3 form-check">
                                <input type="checkbox" class="form-check-input" id="in_stock" name="in_stock" <?php if (isset($_POST['in_stock'])) echo 'checked'; ?> checked>
